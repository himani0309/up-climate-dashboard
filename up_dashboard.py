...
@st.cache_data
def load_data():
    past_df = pd.read_excel("final_climate_mint_dataset.xlsx")
    ssp245_df = pd.read_excel("ssp245_predicted_yield.xlsx")
    ssp585_df = pd.read_excel("ssp585_predicted_yield.xlsx")
